function [vein_seg,vein_seg2]=vessel_seg_chai(magh,uwh,phh,qsmh,maskh,echoes,scales,vein_art,shearSys,do_r2,r2,voxelsize,padsize,do_field,mask01,it)
...
if do_field==1
    [field]=getfield1_chai(uw,ph,voxelsize,padsize,mask01);% corresponds to reg in the publication 2.4
else
    field=ones(size(qsm));
end
...
if vein_art==0 %segment veins
    ...
    % vein_seg=remove_culster(vein_seg,2); %% chai commented
